...
@section('body')
    <div class="row">
        ...
        <h4>
            ...
            <input type="color" class="form-control" name="head" style="width: 120px; height: 50px;">
            <br>
            <b><i class="fa fa-paint-brush"></i> Body background color : </b>
            <input type="color" class="form-control" name="body" style="width: 120px; height: 50px;">
